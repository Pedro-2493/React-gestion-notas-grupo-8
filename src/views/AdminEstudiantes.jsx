                ...
                <tr key={s.id}>
                  {editandoId === s.id ? (
                    <>
                      ...
                      <td>
                        <div className="admin-acciones-btns">
                          <button className="admin-btn-guardar" onClick={() => guardarEdicion(s.id)}>Guardar</button>
                          <button className="admin-btn-cancelar" onClick={cancelarEdicion}>Cancelar</button>
                        </div>
                      </td>
                    </>
                  ) : (
                    <>
                      ...
                      <td>
                        <div className="admin-acciones-btns">
                          <button className="admin-btn-editar" onClick={() => iniciarEdicion(s)}>Editar</button>
                          <button className="admin-btn-eliminar" onClick={() => eliminar(s.id)}>Eliminar</button>
                        </div>
                      </td>
                    </>
                  )}
